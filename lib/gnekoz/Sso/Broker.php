...
class Gnekoz_Sso_Broker
{
     ...
     * @var string
     */
    public $url = "http://polistudio.orion.com/services/sso";
    ...
    {    		    		
        ...
        //echo "login per $username. risultato $ret"; var_dump($body); exit();
